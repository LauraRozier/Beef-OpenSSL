...
namespace Beef_OpenSSL
{
	sealed static class SRTP
	{
		...
		{
			// ERROR: Non-static method 'Beef_OpenSSL.SRTP.sk_SRTP_PROTECTION_PROFILE_new.internalF(void* a, void* b)' cannot match 'Beef_OpenSSL.OpenSSL.sk_compfunc' because it contains captured variables, consider using a delegate or removing captures
		...
		{
			// ERROR: Non-static method 'Beef_OpenSSL.SRTP.sk_SRTP_PROTECTION_PROFILE_new_reserve.internalF(void* a, void* b)' cannot match 'Beef_OpenSSL.OpenSSL.sk_compfunc' because it contains captured variables, consider using a delegate or removing captures
			int internalF(void* a, void* b) => compare((PROTECTION_PROFILE**)a, (PROTECTION_PROFILE**)b);
		...
		{
			// ERROR: Non-static method 'Beef_OpenSSL.SRTP.sk_SRTP_PROTECTION_PROFILE_pop_free.internalF(void* a)' cannot match 'function void(void*)' because it contains captured variables, consider using a delegate or removing captures
		...
		{
			// ERROR: Non-static method 'Beef_OpenSSL.SRTP.sk_SRTP_PROTECTION_PROFILE_deep_copy.internalF1(void* a)' cannot match 'Beef_OpenSSL.OpenSSL.sk_copyfunc' because it contains captured variables, consider using a delegate or removing captures
			void* internalF1 (void* a) => (void*)copyfunc((PROTECTION_PROFILE*)a);
			// ERROR: Non-static method 'Beef_OpenSSL.SRTP.sk_SRTP_PROTECTION_PROFILE_deep_copy.internalF2(void* a)' cannot match 'Beef_OpenSSL.OpenSSL.sk_freefunc' because it contains captured variables, consider using a delegate or removing captures
		...
		{
			// ERROR: Non-static method 'Beef_OpenSSL.SRTP.sk_SRTP_PROTECTION_PROFILE_set_cmp_func.internalF(void* a, void* b)' cannot match 'Beef_OpenSSL.OpenSSL.sk_compfunc' because it contains captured variables, consider using a delegate or removing captures
			int internalF(void* a, void* b) => compare((PROTECTION_PROFILE**)a, (PROTECTION_PROFILE**)b);
